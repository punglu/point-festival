...
| `E2E-LOGIN-001` | Player selection and PIN keypad dashboard transition | `TIER 3 JOURNEY` | `tests/e2e/specs/01-login.spec.ts` | `SELF_CHECKED` | `2026-07-26` | `PENDING_COMMIT` | Passed in isolated `mc_phase0` runtime on port 13000 with synthetic seed data. |
| `E2E-MISSION-001` | Logged-in mission list and proposal control visibility | `TIER 3 JOURNEY` | `tests/e2e/specs/02-mission.spec.ts` | `SELF_CHECKED` | `2026-07-26` | `PENDING_COMMIT` | Passed in isolated `mc_phase0` runtime on port 13000 with synthetic seed data. |
| `E2E-ADMIN-001` | Admin entry form and post-login route | `TIER 3 JOURNEY` | `tests/e2e/specs/03-admin.spec.ts` | `SELF_CHECKED` | `2026-07-26` | `PENDING_COMMIT` | Passed in isolated `mc_phase0` runtime on port 13000 with synthetic seed data. |
| `E2E-FLOW-001` | Player logout and administrator access workflow | `TIER 3 JOURNEY` | `tests/e2e/specs/04-flow.spec.ts` | `SELF_CHECKED` | `2026-07-26` | `PENDING_COMMIT` | Passed in isolated `mc_phase0` runtime on port 13000 with synthetic seed data. |
