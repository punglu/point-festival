import type { DoranPreviewRoom } from './types';

export const doranPreviewRooms: DoranPreviewRoom[] = [
...
export const doranPreviewRoomLabels: Record<DoranPreviewRoom['kind'], string> = {
  DIRECT: '개인 대화',
  GROUP: '가족 그룹',
  SERVICE: '서비스 알림',
};
